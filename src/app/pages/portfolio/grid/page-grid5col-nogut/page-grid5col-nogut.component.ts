...
@Component({
    selector: 'app-page-grid5col-nogut',
    templateUrl: './page-grid5col-nogut.component.html',
    styleUrls: ['./page-grid5col-nogut.component.scss'],
    imports: [Header1Component, BannerComponent, RouterLink, Footer1Component]
})
export class PageGrid5colNogutComponent implements OnInit {
    ...
    items: [
      {
        ...
        category: "cat-5",
        image: "assets/images/projects/square/squa-5.jpg",
        title: "Animation & motion",
        subtitle: "Media Marketing",
        image2: "assets/images/projects/square/squa-5.jpg",
        title2: "Energy",
        subtitle2: "Regulatory Compliance System",
        author: "someone",
        thumb: "assets/images/projects/square/squa-5.jpg"
      },{
        category: "cat-4",
        image: "assets/images/projects/square/squa-6.jpg",
        title: "Development",
        subtitle: "Game Development",
        image2: "assets/images/projects/square/squa-6.jpg",
        title2: "Energy",
        subtitle2: "Regulatory Compliance System",
        author: "someone",
        thumb: "assets/images/projects/square/squa-6.jpg"
      },{
        category: "cat-3",
        ...
        category: "cat-3",
        image: "assets/images/projects/square/squa-10.jpg",
        title: "Development",
        subtitle: "Game Development",
        image2: "assets/images/projects/square/squa-10.jpg",
        title2: "Energy",
        subtitle2: "Regulatory Compliance System",
        author: "someone",
        thumb: "assets/images/projects/square/squa-10.jpg"
      }
    ]
  }
}
