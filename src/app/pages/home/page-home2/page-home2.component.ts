...
@Component({
  ...
  imports: [Header2Component, SectionSlider2Component, SectionAboutCompany1Component, SectionWhatWeDo1Component, SectionOurServices1Component, SectionOurProcess1Component, SectionBlogs2Component, Footer1Component]
})
